// This component displays subjects taught at Fusion Tuition.
// Shows IGCSE, GCE O Level, A Level, and IB subjects with their official codes.

import { motion } from 'framer-motion'
import { GraduationCap } from 'lucide-react'
import React from 'react'

const FindYourClass: React.FC = () => {
  const igcseSubjects = [
